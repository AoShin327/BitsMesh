...
/**
 * BitsMesh Theme - Custom Move Confirmation Dialog
 *
...
<ul class="bits-moderation-options">
    <li class="form-group">
        ...
        echo $this->Form->label(t('Category'), 'CategoryID');
        $options = [
    ...
    <li class="form-group">
        <?php echo $this->Form->checkBox('RedirectLink', t('Leave a redirect link.')); ?>
    </li>
    <li class="form-group bits-separator">
        <hr style="border: 0; border-top: 1px solid var(--bits-border, #ddd); margin: 8px 0;">
    </li>
    <li class="form-group">
...
<div class="Buttons Buttons-Confirm">
    <?php
    echo $this->Form->button('Move', ['class' => 'Button Primary']);
